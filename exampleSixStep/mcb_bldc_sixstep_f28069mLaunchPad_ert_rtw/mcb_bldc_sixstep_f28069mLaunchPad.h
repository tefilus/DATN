...
typedef struct {
  ...
  int32_T DigitalOutput_FRAC_LEN_n;    /* '<S216>/Digital Output' */
 ...
 * '<S202>' : 'mcb_bldc_sixstep_f28069mLaunchPad/Current Control/SCI_Tx/ Code Generation'
 * '<S203>' : 'mcb_bldc_sixstep_f28069mLaunchPad/Current Control/SCI_Tx/ Code Generation/CodeGeneration'
